...
const val CHANNEL = "in.canews.pythonide"
const val EVENT_CHANNEL = "in.canews.pythonide/installModules"
...
class MainActivity : FlutterActivity() {
    ...
    private fun isRequiredModulesInstalled(): Boolean = isModuleInstalled("common_python") == true &&
    ...
    private fun uninstallModules() {
        ...
        splitInstallManager?.deferredUninstall(listOf("common_python", archName + "_python"))?.addOnSuccessListener {
